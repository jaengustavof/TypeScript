...
const ITask_1 = require("./models/interfaces/ITask");
const Develop_1 = require("./models/Develop");
const Singleton_1 = require("./patterns/creational/Singleton");
/**
 * Documentation
 * Multi-line
 */
...
if (peter instanceof Students_1.Student) {
...
let employee1 = new Person_1.Employees('Mark', 'Robertson', 25, 2000);
let employee2 = new Person_1.Employees('Steve', 'Lorens', 42, 5000);
let employee3 = new Person_1.Employees('Paul', 'Merson', 32, 4000);
employee1.greet();
employee2.greet();
employee3.greet();
console.log(`************************************************************`);
...
console.log(`************************************************************`);
let boss1 = new Person_1.Boss("Pablo", "Garcia", 52);
boss1.employees.push(employee1, employee2, employee3);
boss1.employees.forEach((employee) => employee.greet());
console.log(`************************************************************`);
...
let developmentTS = new Develop_1.Develop("TypeScript", "TypeScript development task", false, ITask_1.Levels.Med);
 ...
 * The client code.
 */
const myFirstSingleton = Singleton_1.Singleton.getInstance();
const mySecondSingleton = Singleton_1.Singleton.getInstance();
/*Compares*/
